...
eval_low_data = []
eval_img_name = []
eval_low_data_name = glob('./test_images/MIT5k(4501-5000)-test/low/*')
...
sample_dir = './test_results/MIT5k_result/'
...
for idx in range(len(eval_low_data)):
    ...
    save_images(os.path.join(sample_dir, '%s_GARN.png' % (name)), fusion2)
