...
eval_low_data = []
eval_low_data_names = glob('./LOLdataset/all-plants/val/600x400/low/*')
...
eval_restoration_low_r_data = decomposed_eval_low_r_data
eval_restoration_low_i_data = decomposed_eval_low_i_data
train_restoration_low_r_data = decomposed_low_r_data_480
train_restoration_low_i_data = decomposed_low_i_data_480
train_restoration_high_r_data = decomposed_high_r_data_480
...
print('[*] Number of valing data: %d' % len(eval_restoration_low_r_data))
